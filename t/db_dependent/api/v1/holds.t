...
subtest 'PUT /holds/{hold_id}/priority tests' => sub {
	...
	$t->put_ok( "//$userid_np:$password@/api/v1/holds/" . $hold_3->id . "/priority" => json => 1 )
      ->status_is(403);
    ...
    is( $hold_1->priority, 2, 'Priority adjusted correctly' );
    is( $hold_2->priority, 3, 'Priority adjusted correctly' );
    is( $hold_3->priority, 1, 'Priority adjusted correctly' );

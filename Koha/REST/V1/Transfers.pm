...
Koha::REST::V1::Transfers - Koha REST API for handling item transfers (V1)
...
Cancels the given transfer. The transfer is cancelled with the reason passed
in the request body (defaulting to 'Manual'), and when recalls are in use any
in-transit recall for the item has its transfer reverted.

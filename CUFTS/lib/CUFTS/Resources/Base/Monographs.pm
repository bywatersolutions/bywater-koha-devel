## CUFTS::Resources::Base::Monographs
##
...
package CUFTS::Resources::Base::Monographs;
...
sub can_getHoldings {
    ...
    if ( ($request->genre eq 'book'  || $request->genre eq 'bookitem') &&
         (hascontent($request->isbn) || hascontent($request->title)) ) {
        return 1;
    }

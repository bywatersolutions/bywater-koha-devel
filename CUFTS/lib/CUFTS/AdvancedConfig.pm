...
use vars qw(
    ...
    $RESOLVER_TEMPLATE_DIR
    $RESOLVER_SITE_TEMPLATE_DIR

    $RESOLVER_CSS_DIR
    $RESOLVER_SITE_CSS_DIR
...
$CUFTS_JQ_JOBS_LOG_DIR       = "${CUFTS_LOG_DIR}/jobs";
$CUFTS_TITLE_LIST_UPLOAD_DIR = "${CUFTS_BASE_DIR}/uploads";
$CUFTS_JQ_UPLOAD_DIR         = "${CUFTS_TITLE_LIST_UPLOAD_DIR}/jq";
...
$CUFTS_JQ_LOG      = "${CUFTS_LOG_DIR}/jq_log";
...
$RESOLVER_BASE_DIR = "${CUFTS_BASE_DIR}/Resolver";
$RESOLVER_URL      = 'http://localhost:3000/';

$RESOLVER_TEMPLATE_DIR      = "${RESOLVER_BASE_DIR}/root";
$RESOLVER_SITE_TEMPLATE_DIR = "${RESOLVER_TEMPLATE_DIR}/sites";

$RESOLVER_CSS_DIR      = "${RESOLVER_BASE_DIR}/root/static/css";
$RESOLVER_SITE_CSS_DIR = $RESOLVER_SITE_TEMPLATE_DIR;
